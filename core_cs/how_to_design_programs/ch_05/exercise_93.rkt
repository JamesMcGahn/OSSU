...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname exercise_93) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
