...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname 2-avoiding_Recompution-fs-v6) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;; causes recomputation of find--element exponetial growth
;(define (find n e)
