...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname 3-parameterization-v3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (map2 string-length (list "a" "b" "dc")) (list 1 1 2))
