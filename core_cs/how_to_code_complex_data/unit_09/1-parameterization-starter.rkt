...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname 1-parameterization-starter) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
