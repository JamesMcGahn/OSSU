...
class Book1 {
    ...
    // the constructor
    Book1(String title, Author author, int price) {
        this.title = title;
        this.author = author;
        this.price = price;
    }
...
class ExamplesBooks1 {
    ...
    // examples of books
    Book1 beaches = new Book1("Beaches", this.pat, 20);
    Book1 prince = new Book1("Prince of Tides", this.pat, 15);
    Book1 code = new Book1("Da Vinci Code", this.dan, 20);
