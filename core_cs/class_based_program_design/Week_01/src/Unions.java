 ...
 * +----------+ | IStation | +----------+ +----------+ | / \ --- |
 * ----------------------- | | +--------------+ +-----------------+ | TStop | |
 * CommStation | +--------------+ +-----------------+ | String name | | String
 * name | | String line | | String line | | double price | | boolean express |
 * +--------------+ +-----------------+
 */
...
class ExamplesIStation {
	...
	/*
	 * Harvard station on the Red line costs $1.25 to enter Kenmore station on the
	 * Green line costs $1.25 to enter Riverside station on the Green line costs
	 * $2.50 to enter
	 * 
	 * Back Bay station on the Framingham line is an express stop West Newton stop
	 * on the Framingham line is not an express stop Wellesely Hills on the
	 * Worcester line is not an express stop
	 */
